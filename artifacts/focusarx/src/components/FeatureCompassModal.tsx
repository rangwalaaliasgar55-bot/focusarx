...
export const PLATFORM_FEATURES: FeatureGuideItem[] = [
  ...
  },
  {
    ...
    description:
      "Convert verified focus minutes into Focus Credits, which buy Premium. Unlock seasonal battle pass tiers, discover rare cosmetic aura skins, and complete daily quests.",
    howToUse: [
