    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[var(--z-modal)] bg-[var(--palette-black)]/50 sm:flex sm:items-center sm:justify-center sm:p-6"
          onClick={onClose}
        >
          <motion.div
            ...
            className="fixed inset-x-4 bottom-8 mx-auto max-w-sm rounded-[var(--radius-xl)] border border-[var(--rgba-124-58-237-0_3)] bg-[var(--rgba-12-17-40-0_97)] p-6 sm:static sm:mx-0 sm:w-full"
