      ...
      <div className="min-h-screen bg-[var(--background)]">
        <div className="mx-auto max-w-5xl px-4 py-12">
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-[var(--foreground)] mb-4">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              ...
              <Link href="/premium" className="min-h-[44px] inline-flex items-center justify-center rounded-xl border border-[var(--border-strong)] bg-[var(--muted)] px-6 text-sm font-semibold">View Premium Benefits</Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            {[
              ...
              <div key={c.title} className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-hover)] p-5">
