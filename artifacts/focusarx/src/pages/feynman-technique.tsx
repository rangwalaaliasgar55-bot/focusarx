    ...
    <div className="min-h-screen bg-[#030308] text-[#F8FAFC]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        <header className="text-center mb-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-emerald-300 mb-8">
            <GraduationCap size={12} /> Study Methodology
          </div>
          <h1 className="text-4xl sm:text-7xl font-black tracking-tight mb-6">
            The Feynman <br /><span className="text-emerald-400">Technique</span>
          </h1>
        ...
        <div className="grid gap-12 lg:grid-cols-2 mb-24">
           <div className="relative aspect-video rounded-3xl overflow-hidden border border-white/5 bg-zinc-900 shadow-2xl">
              <img 
        ...
        <div className="space-y-24">
          {[
            ...
            <div key={i} className="flex gap-8 items-start">
               <div className="text-6xl font-black text-white/[0.05] select-none shrink-0">{s.step}</div>
               <div className="pt-2">
                 <h3 className="text-2xl font-bold mb-4 text-white">{s.title}</h3>
                 <p className="text-[#94A3B8] leading-relaxed text-lg">{s.desc}</p>
               </div>
            </div>
          ))}
        </div>

        <div className="mt-32 rounded-3xl border border-white/5 bg-white/[0.02] p-12 text-center relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <p className="text-[#64748B] mb-10 max-w-lg mx-auto">Use our "Explain" mode to practice the Feynman Technique while your AI coach monitors your clarity and identifies logical leaps.</p>
              <Link href="/signup">
                <button className="h-14 px-10 rounded-2xl bg-white text-black font-black hover:bg-zinc-200 transition-all shadow-xl">
                  Start Learning Now
                </button>
              </Link>
           </div>
