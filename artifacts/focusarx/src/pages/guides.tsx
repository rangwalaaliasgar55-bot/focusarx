...
const COLLECTIONS = [
  {
    ...
    guides: [
      { href: "/exam", icon: <GraduationCap size={18} />, label: "All Exam Prep Guides", blurb: "23 practical guides: exam patterns, study plans, daily focus routines, mock protocols, and FAQ — from JEE Main and NEET to BITSAT, CUET, CLAT, GRE and GMAT." },
    ],
  },
  {
