    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <div className="relative overflow-hidden border-b border-[var(--palette-white)]/5">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          <h1 className="text-5xl sm:text-8xl font-semibold text-[var(--palette-white)] mb-6 leading-tight tracking-tight">
            The Pomodoro<br />
            <span className="text-[var(--brand-strong)]">Technique</span>
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 space-y-32">
        ...
        <section className="text-center">
          <h2 className="text-4xl font-semibold text-[var(--palette-white)] mb-12 tracking-tight">The Bio-Logic of 25 Minutes</h2>
        ...
        <section>
          <div className="text-center mb-16">
             <h2 className="text-4xl font-semibold text-[var(--palette-white)] mb-4">Elite Study Protocols</h2>
        ...
        <section className="text-center">
          <div className="rounded-[40px] border border-[var(--palette-red-500)]/20 bg-gradient-to-br from-[var(--palette-red-500)]/10 to-[var(--palette-orange-500)]/5 p-16 relative overflow-hidden">
            ...
            <h2 className="text-4xl sm:text-6xl font-semibold text-[var(--palette-white)] mb-6 tracking-tight">Upgrade Your <br />Learning Output</h2>
