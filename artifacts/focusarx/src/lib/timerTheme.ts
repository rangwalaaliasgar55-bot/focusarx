 ...
 *
 * Three faces for the countdown ring. They apply to the *free* experience
...
export type TimerTheme = "classic" | "neon" | "zen";
...
export function getStoredTimerTheme(): TimerTheme {
  try {
    ...
    if (stored === "classic" || stored === "neon" || stored === "zen") return stored;
  } catch {
