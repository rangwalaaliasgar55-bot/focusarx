...
const APP_ENTRIES: SearchEntry[] = [
  ...
  { path: "/planner", section: "Features", title: "Week Runway", description: "Turn task estimates and due dates into reviewable daily focus blocks across the week.", keywords: "week planner calendar schedule time blocks runway daily plan due date estimates" },
