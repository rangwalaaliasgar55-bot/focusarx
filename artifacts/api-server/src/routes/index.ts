...
import { adminBreakFreeRouter } from "./adminBreakFree";
import { siteRouter } from "./site";
import { flashcardsRouter } from "./flashcards";
import { premiumRouter } from "./premium";
import { emailRouter } from "./email";
import { dropsRouter } from "./drops";
import { arxRouter } from "./arx";
import { adminGeminiRouter } from "./adminGemini";
import { ogRouter } from "./og";
import { adminSqlRouter } from "./adminSql";
...
import { adminPetReleasesRouter } from "./adminPetReleases";
...
router.use(adminBreakFreeRouter);
router.use(siteRouter);
router.use(flashcardsRouter);
router.use(premiumRouter);
router.use(emailRouter);
router.use(dropsRouter);
router.use(arxRouter);
router.use(adminGeminiRouter);
router.use(adminSqlRouter);
...
router.use(adminPetReleasesRouter);
