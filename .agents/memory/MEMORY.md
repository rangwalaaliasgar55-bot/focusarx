...
- [Schema recovery](schema-recovery.md) — canonical idempotent migration (82 tables); prod was missing moderation cols/site_settings/flashcards; guarded ADD CONSTRAINT must catch duplicate_object AND duplicate_table
